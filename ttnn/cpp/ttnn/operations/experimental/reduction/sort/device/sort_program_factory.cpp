...
// Single row - Multi core but distributed (no coordinator)
SortProgramFactorySingleRowMulticoreDistributed::cached_program_t
SortProgramFactorySingleRowMulticoreDistributed::create(
    const operation_attributes_t& attributes, const tensor_args_t& tensor_args, tensor_return_value_t& output_tensors) {
    // Program config
    tt::tt_metal::Program program{};
...
void SortProgramFactorySingleRowMulticoreDistributed::override_runtime_arguments(
    cached_program_t& cached_program,
    const operation_attributes_t& attributes,
    const tensor_args_t& tensor_args,
    tensor_return_value_t& output_tensors) {
