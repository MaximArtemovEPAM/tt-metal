...
operation::ProgramWithCallbacks flash_mla_prefill_multi_core(
    ...
    */
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/dataflow/reader_interleaved.cpp",
        core_grid,
        tt::tt_metal::ReaderDataMovementConfig(reader_compile_time_args, defines));

    auto writer_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/dataflow/writer_interleaved.cpp",
        core_grid,
        tt::tt_metal::WriterDataMovementConfig(writer_compile_time_args, defines));

    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/compute/flash_mla_prefill.cpp",
        core_grid,
    ...
    auto override_runtime_arguments_callback =
        [num_cores, grid_size, reader_kernels_id, writer_kernels_id, compute_kernels_id, is_chunked, q_chunk_size](
            ...
            if (is_chunked) {
                ...
                chunked_q_chunk_offset =
                    static_cast<const FlashMLAPrefill*>(operation)->chunk_start_idx.value() / q_chunk_size;
            }
