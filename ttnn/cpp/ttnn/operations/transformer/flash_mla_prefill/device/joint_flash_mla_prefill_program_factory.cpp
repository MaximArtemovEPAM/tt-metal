...
operation::ProgramWithCallbacks joint_flash_mla_prefill(
    ...
    */
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/dataflow/joint_reader.cpp",
        core_grid,
        tt::tt_metal::ReaderDataMovementConfig(reader_compile_time_args, defines));

    auto writer_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/dataflow/joint_writer.cpp",
        core_grid,
        tt::tt_metal::WriterDataMovementConfig(writer_compile_time_args, defines));

    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_prefill/device/kernels/compute/joint_flash_mla_prefill.cpp",
        core_grid,
