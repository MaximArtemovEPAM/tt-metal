...
#include "flash_mla_prefill_pybind.hpp"

#include <pybind11/pybind11.h>
#include <pybind11/stl.h>

#include "flash_mla_prefill.hpp"
#include "ttnn-pybind/decorators.hpp"

namespace ttnn::operations::transformer {

void py_bind_flash_mla_prefill(py::module& module) {
    auto doc =
        R"doc(
    ...
    using OperationType = decltype(ttnn::transformer::flash_mla_prefill);
    ...
    using ChunkedOperationType = decltype(ttnn::transformer::chunked_flash_mla_prefill);
    ttnn::bind_registered_operation(
        module,
    ...
    using JointOperationType = decltype(ttnn::transformer::joint_flash_mla_prefill);
