...
#include "flash_mla_decode_program_factory.hpp"

#include <optional>

#include <tt-metalium/buffer.hpp>
#include "flash_mla_decode_op.hpp"
...
operation::ProgramWithCallbacks flash_mla_decode_multi_core(
    ...
    */
    ...
    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_decode/device/kernels/compute/sdpa_flash_decode.cpp",
        core_grid,
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_decode/device/kernels/dataflow/reader_decode_all.cpp",
        core_grid,
    ...
    auto writer_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/transformer/flash_mla_decode/device/kernels/dataflow/writer_decode_all.cpp",
        core_grid,
        ...
        [num_active_cores,
         ...
         is_causal](
            ...
            const auto cur_pos_ids =
                static_cast<const ttnn::operations::transformer::FlashMLADecode*>(operation)->cur_pos;
