...
from ufld_v2_standalone1 import process_lane_detection
...
class UFLDv2(GstBase.BaseTransform):
    ...
    def initialize_device(self):
        ...
        self.model = UFLDPerformantRunner(self.device)
        self.model._capture_ufldv2_trace_2cqs()
    ...
    def do_transform(self, inbuf: Gst.Buffer, outbuf: Gst.Buffer) -> Gst.FlowReturn:
        try:
            ...
            outImage = process_lane_detection(torch_frame_data, original_frame_for_drawing, None, self.model)
            print(outImage.shape == original_frame_for_drawing.shape)
