...
def evaluation(
    ...
    for batch in data_set:
        ...
        elif model_name in ["YOLOv8s_World", "YOLOv7"]:
        ...
        if model_name not in ["YOLOv4", "YOLOv9c", "YOLOv10", "YOLOv8s_World", "YOLOv7"]:
    ...
    for ttnn_im, im, im0s in preprocessed_images:
        if model_type == "torch_model":
            ...
            elif model_name in ["YOLOv10", "YOLOv7"]:
    ...
    if model_type == "tt_metal":
        ...
        elif model_name in ["YOLOv10", "YOLOv9c", "YOLOv8s_World", "YOLOv7"]:
            model.release()
    ground_truth = []
    for i in dataset:
        sample = []
