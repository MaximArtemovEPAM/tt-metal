...
def test_geglu(device, input_shape, module_path, pcc, use_program_cache, reset_seeds, ff_weights_dtype):
    ...
    tt_geglu = TtGEGLU(device, state_dict, module_path, model_config, weights_dtype=ff_weights_dtype)
