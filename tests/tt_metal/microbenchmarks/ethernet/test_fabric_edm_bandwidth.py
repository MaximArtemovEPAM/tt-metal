...
def read_golden_results(
    ...
    *,
    ...
    results = df[
        ...
        & (df["Line Size"] == get_report_field(line_size))
        & (df["Num Links"] == get_report_field(num_links))
        & (df["Disable Interior Workers"] == get_report_field(disable_sends_for_interior_workers))
        & (df["Unidirectional"] == get_report_field(unidirectional))
        & (df["Senders Are Unidirectional"] == get_report_field(senders_are_unidirectional))
    ]
