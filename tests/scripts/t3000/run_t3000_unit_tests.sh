...
run_t3000_ttfabric_tests() {
  ...
  TT_METAL_FD_FABRIC=true ./build/test/tt_metal/tt_fabric/fabric_unit_tests --gtest_filter="FabricMuxFixture.*"
  TT_METAL_FD_FABRIC=true ./build/test/tt_metal/tt_fabric/fabric_unit_tests --gtest_filter=T3kCustomMeshGraphFabric2DDynamicTests*
